...
def main():
    ...
    kk_imgs = [kk_img, pg.transform.rotozoom(kk_img, 10, 1.0)] #練習3：こうかとんSurfaceリスト
    tmr = 0
    while True:
        ...
        screen.blit(bg_img, [1600-x, 0]) #練習6：動く背景画像
        screen.blit(kk_imgs[tmr%2], [300, 200]) #練習5：こうかとん羽ばたく
        pg.display.update()
        tmr += 1        
        clock.tick(100)
